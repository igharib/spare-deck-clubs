...
test('index includes the Zoho SalesIQ widget before closing body', () => {
  ...
  assert.match(html, /<script>window\.\$zoho=window\.\$zoho \|\| \{\};\$zoho\.salesiq=\$zoho\.salesiq\|\|\{ready:function\(\)\{\}\}<\/script>\s*<script id="zsiqscript" src="https:\/\/salesiq\.zohopublic\.com\/widget\?wc=siq93f5982906e13c86fd752d6d37194d3f4938738ad178cbd91f75048dd0fc02f6" defer><\/script>[\s\S]*<\/body>/);
});
